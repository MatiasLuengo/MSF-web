export const Banner2 = ({ img , img2,  alt , text }) => {
    return(<>
        ...
        <div className="relative flex justify-center items-center w-full  min-[570px]:h-[17rem] min-[890px]:h-[22rem] min-[1190px]:h-[29rem]">
            <img loading="lazy" className="min-h-[250px] block h-full w-full min-[570px]:w-1/2" src={img} alt={alt} />
            <img loading="lazy" className="min-h-[250px] hidden min-[570px]:block h-full w-1/2" src={img2} alt={alt} />
